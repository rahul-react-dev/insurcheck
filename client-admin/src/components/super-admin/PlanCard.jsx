...
const PlanCard = ({ plan }) => {
  ...
  return (
    <Card className={`p-6 hover:shadow-lg transition-all duration-200 ${colorClasses[color]} border-2`}>
      ...
      <div className="border-t border-gray-200 pt-4 mb-4">
        <h4 className="font-semibold text-gray-900 mb-3">Features & Limits</h4>
