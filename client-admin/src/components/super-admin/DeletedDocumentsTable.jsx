  ...
  if (loading) {
    return (
      <div className="p-8 text-center">
        ...
        <p className="text-gray-500">Please wait while we fetch the deleted documents...</p>
      </div>
    );
  }
  ...
  if (!documents || documents.length === 0) {
    return (
      <div className="p-8 text-center">
        ...
        <p className="text-gray-500">No deleted documents found matching your criteria.</p>
      </div>
    );
  }
              ...
              <tr key={document.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    <i className={`${getDocumentTypeIcon(document.name)} mr-3`}></i>
                    <div>
          ...
          <div key={document.id} className="bg-white border border-gray-200 rounded-lg p-4">
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center flex-1 min-w-0">
                <i className={`${getDocumentTypeIcon(document.name)} mr-3 flex-shrink-0`}></i>
            ...
            <div className="grid grid-cols-2 gap-3 text-xs mb-4">
              <div>
                ...
                <p className="text-gray-900 font-medium truncate">{document.deletedBy}</p>
              </div>
              <div>
                <span className="text-gray-500">Original Owner:</span>
                <p className="text-gray-900 font-medium truncate">{document.originalOwner}</p>
              </div>
              <div>
                <span className="text-gray-500">Deleted Date:</span>
                <p className="text-gray-900 font-medium">{formatDate(document.deletedAt)}</p>
              </div>
              <div>
                <span className="text-gray-500">Size:</span>
                <p className="text-gray-900 font-medium">{(document.size / 1024).toFixed(1)} KB</p>
              </div>
            </div>
