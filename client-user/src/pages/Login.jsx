...
const Login = () => {
  ...
  const [formData, setFormData] = useState({
    email: '',
    password: '',
    role: 'user', // Default to user role for user frontend
    rememberMe: false
  });
    ...
    <div className="min-h-screen gradient-primary flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <Card className="bg-white rounded-2xl shadow-2xl p-8 space-y-6">
          ...
          {/* Role Selection - Only User for this frontend */}
          <div className="space-y-3">
            <label className="block text-sm font-medium text-gray-800">Your Role</label>
